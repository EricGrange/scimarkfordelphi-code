...
function new_Random_seed(seed: integer): PRandom;
function Random_nextDouble(R: PRandom): double;
procedure Random_delete(R: PRandom);
function RandomVector(N: integer; R: PRandom): PDoubleArray;
function RandomMatrix(m, N: integer; R: PRandom): PArrayofDoubleArray;
...
procedure initialize(R: PRandom; seed: integer);
Var
...
function new_Random(seed: integer; left, right: double): PRandom;
Var
  R: PRandom;
Begin
  GetMem(R, sizeof(Random_struct));
