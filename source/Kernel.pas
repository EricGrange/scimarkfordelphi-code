...
uses
  Random, Array2D, Stopwatch, MonteCarlo, SOR, SparseCompRow, FFT, LU;

function kernel_measureFFT(N: integer; min_time: double; R: PRandom): double;
function kernel_measureSOR(N: integer; min_time: double; R: PRandom): double;
function kernel_measureMonteCarlo(min_time: double; R: PRandom): double;
function kernel_measureSparseMatMult(N: integer; nz: integer; min_time: double; R: PRandom): double;
