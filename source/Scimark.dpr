...
begin
  try
    ...
    {$ifdef WIN32}
      ...
      if CompilerVersion=33 then Writeln('Compiled with Delphi XE10.3.2 Rio 32-Bit');
    {$endif}
    {$ifdef WIN64}
      ...
      if CompilerVersion=33 then Writeln('Compiled with Delphi XE10.3.2 Rio 64-Bit');
    {$endif}
